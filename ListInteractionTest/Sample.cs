...
namespace sp_rwu8 {
	...
	public partial class SampleDataContext : Microsoft.SharePoint.Linq.DataContext {
		
		#region Extensibility Method Definitions
		partial void OnCreated();
		#endregion
		
		public SampleDataContext(string requestUrl) : 
				base(requestUrl) {
			this.OnCreated();
		}
		...
		[Microsoft.SharePoint.Linq.ListAttribute(Name="Sample")]
		public Microsoft.SharePoint.Linq.EntityList<SampleItem> Sample {
			get {
				return this.GetList<SampleItem>("Sample");
			}
		}
		...
		/// <summary>
		/// A list containing all relevant forms of information
		/// </summary>
		[Microsoft.SharePoint.Linq.ListAttribute(Name="VPN Request Information")]
		public Microsoft.SharePoint.Linq.EntityList<VPNRequestInformationItem> VPNRequestInformation {
			get {
				return this.GetList<VPNRequestInformationItem>("VPN Request Information");
			}
		}
	}
	...
	[Microsoft.SharePoint.Linq.DerivedEntityClassAttribute(Type=typeof(SampleItem))]
	...
	[Microsoft.SharePoint.Linq.DerivedEntityClassAttribute(Type=typeof(VPNRequestInformationItem))]
	...
	/// Create a new list item.
	/// </summary>
	[Microsoft.SharePoint.Linq.ContentTypeAttribute(Name="Item", Id="0x01", List="Sample")]
	public partial class SampleItem : Item {
		...
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="First_x0020_Name", Storage="_firstName", FieldType="Text")]
		...
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="Last_x0020_Name", Storage="_lastName", FieldType="Text")]
	...
	/// Create a new list item.
	/// </summary>
	[Microsoft.SharePoint.Linq.ContentTypeAttribute(Name="Item", Id="0x01", List="VPN Request Information")]
	public partial class VPNRequestInformationItem : Item {
		
		private string _vPNRecipientFirst;
		
		private string _vPNRecipientLast;
		
		private string _vPNUserCode;
		
		private string _workPhone;
		
		private string _vPNRecipientEmail;
		
		private string _companyName;
		
		private string _officeAddress;
		
		private string _systemsList;
		
		private string _vPNJustification;
		
		private System.Nullable<System.DateTime> _vPNAccessStart;
		
		private System.Nullable<System.DateTime> _vPNAccessEnd;
		
		private System.Nullable<int> _vPNRequestWorkflow;
		
		private string _vPNRequestStatus;
		
		private string _requestID;
		
		private System.Nullable<VPNUserStatus> _vPNUserStatus;
		
		private System.Nullable<VPNUserDept> _vPNUserDept;
		
		private System.Nullable<MachineOwner> _machineOwner;
		
		private System.Nullable<int> _vPNRequesterId;
		
		private string _vPNRequesterImnName;
		
		private System.Nullable<int> _managerId;
		
		private string _managerImnName;
		...
		public VPNRequestInformationItem() {
			this.OnCreated();
		}
		
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="VPN_x0020_Recipient_x0020_First", Storage="_vPNRecipientFirst", Required=true, FieldType="Text")]
		public string VPNRecipientFirst {
			get {
				return this._vPNRecipientFirst;
			}
			set {
				if ((value != this._vPNRecipientFirst)) {
					this.OnPropertyChanging("VPNRecipientFirst", this._vPNRecipientFirst);
					this._vPNRecipientFirst = value;
					this.OnPropertyChanged("VPNRecipientFirst");
				}
			}
		}
		
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="VPN_x0020_Recipient_x0020_Last", Storage="_vPNRecipientLast", Required=true, FieldType="Text")]
		public string VPNRecipientLast {
			get {
				return this._vPNRecipientLast;
			}
			set {
				if ((value != this._vPNRecipientLast)) {
					this.OnPropertyChanging("VPNRecipientLast", this._vPNRecipientLast);
					this._vPNRecipientLast = value;
					this.OnPropertyChanged("VPNRecipientLast");
				}
			}
		}
		
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="VPN_x0020_User_x0020_Code", Storage="_vPNUserCode", Required=true, FieldType="Text")]
		public string VPNUserCode {
			get {
				return this._vPNUserCode;
			}
			set {
				if ((value != this._vPNUserCode)) {
					this.OnPropertyChanging("VPNUserCode", this._vPNUserCode);
					this._vPNUserCode = value;
					this.OnPropertyChanged("VPNUserCode");
				}
			}
		}
		
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="Work_x0020_Phone", Storage="_workPhone", Required=true, FieldType="Text")]
		...
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="VPN_x0020_Recipient_x0020_Email", Storage="_vPNRecipientEmail", Required=true, FieldType="Text")]
		public string VPNRecipientEmail {
			get {
				return this._vPNRecipientEmail;
			}
			set {
				if ((value != this._vPNRecipientEmail)) {
					this.OnPropertyChanging("VPNRecipientEmail", this._vPNRecipientEmail);
					this._vPNRecipientEmail = value;
					this.OnPropertyChanged("VPNRecipientEmail");
				}
			}
		}
		
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="Company_x0020_Name", Storage="_companyName", Required=true, FieldType="Text")]
		...
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="Office_x0020_Address", Storage="_officeAddress", Required=true, FieldType="Text")]
		public string OfficeAddress {
			get {
				return this._officeAddress;
			}
			set {
				if ((value != this._officeAddress)) {
					this.OnPropertyChanging("OfficeAddress", this._officeAddress);
					this._officeAddress = value;
					this.OnPropertyChanged("OfficeAddress");
				}
			}
		}
		
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="Systems_x0020_List", Storage="_systemsList", Required=true, FieldType="Note")]
		public string SystemsList {
			get {
				return this._systemsList;
			}
			set {
				if ((value != this._systemsList)) {
					this.OnPropertyChanging("SystemsList", this._systemsList);
					this._systemsList = value;
					this.OnPropertyChanged("SystemsList");
				}
			}
		}
		
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="VPN_x0020_Justification", Storage="_vPNJustification", Required=true, FieldType="Note")]
		public string VPNJustification {
			get {
				return this._vPNJustification;
			}
			set {
				if ((value != this._vPNJustification)) {
					this.OnPropertyChanging("VPNJustification", this._vPNJustification);
					this._vPNJustification = value;
					this.OnPropertyChanged("VPNJustification");
				}
			}
		}
		
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="VPN_x0020_Access_x0020_Start", Storage="_vPNAccessStart", Required=true, FieldType="DateTime")]
		public System.Nullable<System.DateTime> VPNAccessStart {
			get {
				return this._vPNAccessStart;
			}
			set {
				if ((value != this._vPNAccessStart)) {
					this.OnPropertyChanging("VPNAccessStart", this._vPNAccessStart);
					this._vPNAccessStart = value;
					this.OnPropertyChanged("VPNAccessStart");
				}
			}
		}
		
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="VPN_x0020_Access_x0020_End", Storage="_vPNAccessEnd", Required=true, FieldType="DateTime")]
		public System.Nullable<System.DateTime> VPNAccessEnd {
			get {
				return this._vPNAccessEnd;
			}
			set {
				if ((value != this._vPNAccessEnd)) {
					this.OnPropertyChanging("VPNAccessEnd", this._vPNAccessEnd);
					this._vPNAccessEnd = value;
					this.OnPropertyChanged("VPNAccessEnd");
				}
			}
		}
		
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="VPNReque", Storage="_vPNRequestWorkflow", ReadOnly=true, FieldType="WorkflowStatus")]
		public System.Nullable<int> VPNRequestWorkflow {
			get {
				return this._vPNRequestWorkflow;
			}
			set {
				if ((value != this._vPNRequestWorkflow)) {
					this.OnPropertyChanging("VPNRequestWorkflow", this._vPNRequestWorkflow);
					this._vPNRequestWorkflow = value;
					this.OnPropertyChanged("VPNRequestWorkflow");
				}
			}
		}
		
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="VPN_x0020_Request_x0020_Status", Storage="_vPNRequestStatus", FieldType="Text")]
		public string VPNRequestStatus {
			get {
				return this._vPNRequestStatus;
			}
			set {
				if ((value != this._vPNRequestStatus)) {
					this.OnPropertyChanging("VPNRequestStatus", this._vPNRequestStatus);
					this._vPNRequestStatus = value;
					this.OnPropertyChanged("VPNRequestStatus");
				}
			}
		}
		
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="Request_x0020_ID", Storage="_requestID", FieldType="Text")]
		...
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="VPN_x0020_User_x0020_Status", Storage="_vPNUserStatus", Required=true, FieldType="Choice")]
		public System.Nullable<VPNUserStatus> VPNUserStatus {
			get {
				return this._vPNUserStatus;
			}
			set {
				if ((value != this._vPNUserStatus)) {
					this.OnPropertyChanging("VPNUserStatus", this._vPNUserStatus);
					this._vPNUserStatus = value;
					this.OnPropertyChanged("VPNUserStatus");
				}
			}
		}
		
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="VPN_x0020_User_x0020_Dept", Storage="_vPNUserDept", Required=true, FieldType="Choice")]
		public System.Nullable<VPNUserDept> VPNUserDept {
			get {
				return this._vPNUserDept;
			}
			set {
				if ((value != this._vPNUserDept)) {
					this.OnPropertyChanging("VPNUserDept", this._vPNUserDept);
					this._vPNUserDept = value;
					this.OnPropertyChanged("VPNUserDept");
				}
			}
		}
		
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="Machine_x0020_Owner", Storage="_machineOwner", Required=true, FieldType="Choice")]
		public System.Nullable<MachineOwner> MachineOwner {
			get {
				return this._machineOwner;
			}
			set {
				if ((value != this._machineOwner)) {
					this.OnPropertyChanging("MachineOwner", this._machineOwner);
					this._machineOwner = value;
					this.OnPropertyChanged("MachineOwner");
				}
			}
		}
		
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="VPN_x0020_Requester", Storage="_vPNRequesterId", Required=true, FieldType="User", IsLookupId=true)]
		public System.Nullable<int> VPNRequesterId {
			get {
				return this._vPNRequesterId;
			}
			set {
				if ((value != this._vPNRequesterId)) {
					this.OnPropertyChanging("VPNRequesterId", this._vPNRequesterId);
					this._vPNRequesterId = value;
					this.OnPropertyChanged("VPNRequesterId");
				}
			}
		}
		
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="VPN_x0020_Requester", Storage="_vPNRequesterImnName", ReadOnly=true, FieldType="User", IsLookupValue=true)]
		public string VPNRequesterImnName {
			get {
				return this._vPNRequesterImnName;
			}
			set {
				if ((value != this._vPNRequesterImnName)) {
					this.OnPropertyChanging("VPNRequesterImnName", this._vPNRequesterImnName);
					this._vPNRequesterImnName = value;
					this.OnPropertyChanged("VPNRequesterImnName");
				}
			}
		}
		
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="Manager", Storage="_managerId", Required=true, FieldType="User", IsLookupId=true)]
		public System.Nullable<int> ManagerId {
			...
			set {
				if ((value != this._managerId)) {
					this.OnPropertyChanging("ManagerId", this._managerId);
		...
		[Microsoft.SharePoint.Linq.ColumnAttribute(Name="Manager", Storage="_managerImnName", ReadOnly=true, FieldType="User", IsLookupValue=true)]
		public string ManagerImnName {
			get {
				return this._managerImnName;
			}
			set {
				if ((value != this._managerImnName)) {
					this.OnPropertyChanging("ManagerImnName", this._managerImnName);
					this._managerImnName = value;
					this.OnPropertyChanged("ManagerImnName");
				}
			}
		}
	}
	...
	public enum VPNUserStatus : int {
		
		None = 0,
		
		Invalid = 1,
		
		[Microsoft.SharePoint.Linq.ChoiceAttribute(Value="QTC Regular Employee")]
		QTCRegularEmployee = 2,
		
		[Microsoft.SharePoint.Linq.ChoiceAttribute(Value="Temp Employee")]
		TempEmployee = 4,
		
		[Microsoft.SharePoint.Linq.ChoiceAttribute(Value="Contractor")]
		Contractor = 8,
		
		[Microsoft.SharePoint.Linq.ChoiceAttribute(Value="Consultant")]
		Consultant = 16,
		
		[Microsoft.SharePoint.Linq.ChoiceAttribute(Value="Transcriber")]
		Transcriber = 32,
		
		[Microsoft.SharePoint.Linq.ChoiceAttribute(Value="QTC Provider")]
		QTCProvider = 64,
		
		[Microsoft.SharePoint.Linq.ChoiceAttribute(Value="LMCO Employee (non-QTC)")]
		LMCOEmployeeNonQTC = 128,
	}
	
	public enum VPNUserDept : int {
		
		None = 0,
		
		Invalid = 1,
		
		[Microsoft.SharePoint.Linq.ChoiceAttribute(Value="CLS")]
		CLS = 2,
		
		[Microsoft.SharePoint.Linq.ChoiceAttribute(Value="CRP")]
		CRP = 4,
		
		[Microsoft.SharePoint.Linq.ChoiceAttribute(Value="IT")]
		IT = 8,
		
		[Microsoft.SharePoint.Linq.ChoiceAttribute(Value="STS")]
		STS = 16,
		
		[Microsoft.SharePoint.Linq.ChoiceAttribute(Value="VAS")]
		VAS = 32,
		
		[Microsoft.SharePoint.Linq.ChoiceAttribute(Value="VHA")]
		VHA = 64,
	}
	
	public enum MachineOwner : int {
		
		None = 0,
		
		Invalid = 1,
		
		[Microsoft.SharePoint.Linq.ChoiceAttribute(Value="QTC Owner PC")]
		QTCOwnerPC = 2,
		
		[Microsoft.SharePoint.Linq.ChoiceAttribute(Value="Company Asset (Non-QTC)")]
		CompanyAssetNonQTC = 4,
		
		[Microsoft.SharePoint.Linq.ChoiceAttribute(Value="Personal PC")]
		PersonalPC = 8,
	}
}
